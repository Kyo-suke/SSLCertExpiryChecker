...
c(null)})}catch(h){this._status="ng",this._result=null,console.error("failed to inquery."),console.error(h.message),console.error(h.stack)}};a._getDateString=function(c){function d(c,a,d){var b="";try{b=(Array(d+1).join(a.slice(0,1))+c).slice(-1*d)}catch(m){b=""+c}return b}function a(c){var a=Math.abs(100*c.getTimezoneOffset()/60);return(0<c.getTimezoneOffset()?"-":"+")+d(a,"0",4)}if(!c)return"-";var b="";try{var f=new Date(c);b+=d(f.getFullYear(),"0",4);b+="/"+d(f.getMonth()+1,"0",2);b+="/"+d(f.getDate(),
...
a.showLoading=function(c){var a=jQuery("#"+this.LOADING_ID);c?a.addClass("loaded"):a.removeClass("loaded")};a.initDataTables=function(){jQuery.extend(jQuery.fn.dataTable.defaults,{language:this.DATATABLES_JP})};a.setTableRow=function(c){jQuery("#"+this.TABLE_ID).DataTable({data:c,columns:[{data:"hostname"},{data:"status"},{data:"sdate"},{data:"edate"}],scrollCollapse:!0,pageLength:50,rowCallback:function(c,a){switch(a.status){case "valid":jQuery(c).addClass("valid");break;case "warn":jQuery(c).addClass("warn");
break;case "expired":jQuery(c).addClass("expired");break;default:jQuery(c).addClass("unknown")}}})};a.clearTable=function(){jQuery("#"+this.TABLE_ID+" tbody").empty()};a.TABLE_ID="ssl-cert-status";a.LOADING_ID="loading";a.CSV_DOWNLOAD_BUTTON_ID="csv-download-button";a.RELOAD_BUTTON_ID="reload-button";a.DATATABLES_JP={sProcessing:"\u51e6\u7406\u4e2d...",sLengthMenu:"_MENU_ \u4ef6\u8868\u793a",sZeroRecords:"\u30c7\u30fc\u30bf\u306f\u3042\u308a\u307e\u305b\u3093\u3002",sInfo:" _TOTAL_ \u4ef6\u4e2d _START_ \u304b\u3089 _END_ \u307e\u3067\u8868\u793a",
sInfoEmpty:" 0 \u4ef6\u4e2d 0 \u304b\u3089 0 \u307e\u3067\u8868\u793a",sInfoFiltered:"\uff08\u5168 _MAX_ \u4ef6\u3088\u308a\u62bd\u51fa\uff09",sInfoPostFix:"",sSearch:"\u691c\u7d22:",sUrl:"",oPaginate:{sFirst:"\u5148\u982d",sPrevious:"\u524d",sNext:"\u6b21",sLast:"\u6700\u7d42"}};return a}();b.UIManager=e})(SSLCertChecker||(SSLCertChecker={}));
