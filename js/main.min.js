...
(function(b){var e=function(){function a(){throw Error("Inqueryer is static class.");}a.initialize=function(){jQuery("[data-toggle='tooltip'").tooltip();jQuery("#"+this.CSV_DOWNLOAD_BUTTON_ID).on("click",function(){b.CSVDownloader.download()});a.initDataTables()};a.showLoading=function(c){var a=jQuery("#"+this.LOADING_ID);c?a.addClass("loaded"):a.removeClass("loaded")};a.initDataTables=function(){jQuery.extend(jQuery.fn.dataTable.defaults,{language:this.DATATABLES_JP})};a.setTableRow=function(c){jQuery("#"+
this.TABLE_ID).DataTable({data:c,columns:[{data:"hostname"},{data:"status"},{data:"sdate"},{data:"edate"}],scrollCollapse:!0,pageLength:50,rowCallback:function(c,a){switch(a.status){case "valid":jQuery(c).addClass("valid");break;case "warn":jQuery(c).addClass("warn");break;case "expired":jQuery(c).addClass("expired");break;default:jQuery(c).addClass("unknown")}}})};a.clearTable=function(){jQuery("#"+this.TABLE_ID+" tbody").empty()};a.TABLE_ID="ssl-cert-status";a.LOADING_ID="loading";a.CSV_DOWNLOAD_BUTTON_ID=
"csv-download-button";a.DATATABLES_JP={sProcessing:"\u51e6\u7406\u4e2d...",sLengthMenu:"_MENU_ \u4ef6\u8868\u793a",sZeroRecords:"\u30c7\u30fc\u30bf\u306f\u3042\u308a\u307e\u305b\u3093\u3002",sInfo:" _TOTAL_ \u4ef6\u4e2d _START_ \u304b\u3089 _END_ \u307e\u3067\u8868\u793a",sInfoEmpty:" 0 \u4ef6\u4e2d 0 \u304b\u3089 0 \u307e\u3067\u8868\u793a",sInfoFiltered:"\uff08\u5168 _MAX_ \u4ef6\u3088\u308a\u62bd\u51fa\uff09",sInfoPostFix:"",sSearch:"\u691c\u7d22:",sUrl:"",oPaginate:{sFirst:"\u5148\u982d",sPrevious:"\u524d",
sNext:"\u6b21",sLast:"\u6700\u7d42"}};return a}();b.UIManager=e})(SSLCertChecker||(SSLCertChecker={}));(function(b){function e(a){b.UIManager.clearTable();b.UIManager.showLoading(!0);a&&(a=b.Inqueryer.getCertStatusList(),b.UIManager.setTableRow(a))}b.TARGET_CGI="./GetSSLCertStatus.cgi";b.update=e;b.main=function(){b.UIManager.initialize();b.Inqueryer.inquery(e)};document.addEventListener("DOMContentLoaded",function(){b.main()})})(SSLCertChecker||(SSLCertChecker={}));
(function(b){var e=function(){function a(){throw Error("Downloader is static class.");}a._makeCSVBlob=function(c,a,k){c||(c="text/csv");"boolean"!==typeof a&&(a=!0);k||(k="crlf");try{var d=b.Inqueryer.getCertStatusList(),f=[];a&&f.push(this.BOM);var l=this._getLineFeedCode(k);f.push("\u30db\u30b9\u30c8\u540d,\u8a3c\u660e\u66f8\u72b6\u614b,\u671f\u9650\u958b\u59cb\u65e5,\u671f\u9650\u7d42\u4e86\u65e5"+l);for(a=0;a<d.length;a++){var g=d[a],e=[g.hostname,g.status,g.sdate,g.edate].join();f.push(e+l)}var p=
new Blob(f,{type:c})}catch(m){console.error("failed to make blob."),console.error(m.message),console.error(m.stack)}return p};a._getLineFeedCode=function(a){switch(a){case "cr":a="\r";break;case "lf":a="\n";break;case "crlf":a="\r\n";break;default:throw Error("Invalid linefeed code.");}return a};a._getFilename=function(a){function c(a,c,b){var d="";try{d=(Array(b+1).join(c.slice(0,1))+a).slice(-1*b)}catch(p){d=""+a}return d}a||(a=this.DEFAULT_FILENAME);var b=new Date,e=[c(b.getFullYear(),"0",4),c(b.getMonth()+
